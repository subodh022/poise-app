                    ...
                    '<tpl for="options">',
                        ...
                        '<tr class="x-option-item dynamic-options">',
                            ...
                            '<td class="no-padding">',
                                '<tpl for="operator">',
                                    '<div>',
                                        '<span class="op-boxed {name_class}">{[values.name ? values.name : "<i>Not Assigned</i>"]}</span>',
                                        '<span class="op-boxed {skill_class}">{[values.skill ? "Skill - " + values.skill : "<i>Not Assigned</i>"]}</span>',
                                    '</div>',
                                '</tpl>',
                            '</td>',
                            '<td class="no-padding">',
